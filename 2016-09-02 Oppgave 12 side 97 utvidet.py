...
########################################################################
# Påbgyning fra 02/09-16.
# Skal fortelle om alle aksjene er solgt, og om det var enn god eller dårlig investering!

if antall_aksjer_solgt < antall_aksjer_buy:
    print('Alle aksjene er ikke realsiert, ikke i stand til å bergne netto sum.')
else:
    # Skriv ut resultatet, om Joe har tjent eller tapt penger /P
    print('\nJoe sitter igjen med:', format(float(tot_overskudd), '.2f'), 'kroner.')
    if tot_overskudd > 0:
        print('Dette var en god investering!')
    else:
        print('Dette var en dårlig investering!')
